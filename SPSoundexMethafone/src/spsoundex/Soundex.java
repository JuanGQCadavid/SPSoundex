...
public class Soundex {
    ...
    public static void main(String[] args) {
        System.out.println("Metafone code of abandoner: " + metaphone("abandoner"));
     ...
     * @return int
     */
    public static int getMaxCodeLen() { return maxCodeLen; }

    /**
     * Sets the maxCodeLen.
     * @param maxCodeLen The maxCodeLen to set
     */
    public static void setMaxCodeLen(final int maxCodeLen) { Soundex.maxCodeLen = maxCodeLen; }
